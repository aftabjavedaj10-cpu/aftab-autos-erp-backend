  ...
  return (
    <div className="erp-compact animate-in fade-in duration-500 relative">
      ...
      {previewImage && (
        ...
        >
          <div
            className="relative w-full max-w-3xl bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-2xl overflow-hidden"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex items-center justify-between px-4 py-3 border-b border-slate-100 dark:border-slate-800">
              <h4 className="text-sm font-black text-slate-900 dark:text-white uppercase tracking-wide truncate pr-3">
                {previewImage.name}
              </h4>
              <button
                onClick={() => setPreviewImage(null)}
                className="w-8 h-8 rounded-lg border border-slate-200 dark:border-slate-700 text-slate-500 hover:text-slate-900 dark:hover:text-white"
            ...
            <div className="p-4 bg-slate-50 dark:bg-slate-950">
              <img
                ...
                className="w-full max-h-[75vh] object-contain rounded-xl bg-white dark:bg-slate-900"
              />
            </div>
          </div>
        </div>
