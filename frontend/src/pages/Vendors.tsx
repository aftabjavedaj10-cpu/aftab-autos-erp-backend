                  ...
                  <td className="px-6 py-5">
                    <div className="flex items-center justify-center">
                      ...
                      <button 
                        ...
                        className={`w-4 h-4 rounded border-2 transition-all flex items-center justify-center ${vendor.id && selectedIds.has(vendor.id) ? 'bg-orange-600 border-orange-600 shadow-lg shadow-orange-600/20' : 'border-slate-200 dark:border-slate-700'}`}
                      >
