...
interface PurchaseOrderPageProps {
  ...
  onAddClick: () => void;
  onEditClick: (invoice: PurchaseOrder) => void;
  onDelete: (id: string) => void;
  statusFilterPreset?: string;
  statusFilterPresetTick?: number;
}

const PurchaseOrderPage: React.FC<PurchaseOrderPageProps> = ({
  invoices,
  onAddClick,
  onEditClick,
  onDelete,
  ...
  const handleBulkDelete = () => {
    ...
    setSuccessMsg(`Moved ${selectedIds.size} purchase orders to Deleted status.`);
    setSelectedIds(new Set());
    ...
    <div className="animate-in fade-in duration-500 relative">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 mb-4">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <FiPlus className="text-[12px]" /> Create Purchase Order
          </button>
        </div>
      </div>
        ...
        <div className="p-4 border-b border-slate-50 dark:border-slate-800 space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
            <div className="md:col-span-3 relative">
              ...
              <input
                type="text"
                placeholder="Purchase Order # or Vendor..."
          ...
          <div className="relative bg-white dark:bg-slate-900 w-full max-w-md rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300">
            ...
            <div className="p-10 text-center">
              ...
              <p className="text-slate-500 dark:text-slate-400 font-medium leading-relaxed mb-8 px-4">
                ...
                <span className="text-rose-600 font-black">{selectedIds.size} orders</span> to
                Deleted status? Orders must be Void first and will remain in database.
              </p>
