    ...
    <div className="min-h-screen flex items-center justify-center bg-[#fcf8f2] dark:bg-[#020617] px-4 transition-colors duration-1000 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md">
        <div className="flex flex-col items-center mb-10 text-center">
          <div className="w-24 h-24 bg-gradient-to-br from-orange-500 to-orange-700 rounded-[2.5rem] flex items-center justify-center text-5xl font-black text-white shadow-2xl shadow-orange-600/40 ring-8 ring-white dark:ring-slate-900 mb-6 overflow-hidden">
            {companyLogo ? (
          ...
          <p className="text-slate-400 dark:text-slate-500 text-[9px] font-black uppercase tracking-[0.6em]">
            First Setup
          </p>
        </div>
          ...
          <div className="p-10 md:p-14">
            <form onSubmit={handleSubmit} className="space-y-5">
              <input
                ...
                className="w-full bg-white dark:bg-slate-800/40 border border-slate-100 dark:border-slate-700/50 rounded-2xl py-4 px-5 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-orange-500 focus:border-orange-500 transition-all font-bold text-sm"
                value={fullName}
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-white dark:bg-slate-800/40 border border-slate-100 dark:border-slate-700/50 rounded-2xl py-4 px-5 pr-12 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-orange-500 focus:border-orange-500 transition-all font-bold text-sm"
                  value={password}
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-slate-900 dark:bg-orange-600 hover:bg-orange-600 dark:hover:bg-orange-500 text-white font-black py-5 rounded-[1.5rem] shadow-2xl shadow-orange-600/30 transition-all active:scale-[0.98] disabled:opacity-50 flex items-center justify-center gap-4 text-xs uppercase tracking-[0.4em]"
              >
